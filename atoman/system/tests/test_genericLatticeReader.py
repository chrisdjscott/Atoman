...
class TestReadLatticeGeneric(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # lattice reader
        self.reader = latticeReaderGeneric.LatticeReaderGeneric(self.tmpLocation, updateProgress=updateProgress,
                                                                hideProgress=hideProgess)
    ...
    def test_readGenericLbomdLattice(self):
        ...
        self.assertIsInstance(state.specieList, list)
