...
class TestAntisiteRenderer(unittest.TestCase):
    """
    Test the antisite renderer
    ...
    def test_antisiteRenderer(self):
        """
        Antisite renderer
        
        """
        # the renderer
        renderer = antisiteRenderer.AntisiteRenderer()
